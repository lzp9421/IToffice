@include('layout.header', ['title' => '修改'])
...
<div class="admin-content">
    <div class="admin-content-body">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改记录</strong> / <small>一些常用模块</small></div>
        </div>
...
@include('layout.footer', ['js' => 'details/edit'])